...
interface BuildCommandPaletteOptions {
  uiStore: ReturnType<typeof useUIStore>
  editorStore: ReturnType<typeof useEditorStore>
  formatContent: () => Promise<unknown>
  withEditor: (run: (view: EditorView) => void | Promise<void>) => void
}
...
export function buildCommandPaletteCommands({
  ...
  formatContent,
  withEditor,
}: BuildCommandPaletteOptions): PaletteCommand[] {
  const commands: PaletteCommand[] = [
    ...
    },
    {
      ...
      action: () => {
        uiStore.isOpenPostSlider = !uiStore.isOpenPostSlider
      },
    },
    {
      ...
      action: () => {
        uiStore.isOpenFolderPanel = !uiStore.isOpenFolderPanel
      },
    },
    {
      id: `open-css-editor`,
    ...
    },
    {
      ...
      action: () => {
        uiStore.toggleShowImportMdDialog(true)
      },
    },
    {
      id: `template-dialog`,
    ...
    },
    {
      ...
      action: () => {
        uiStore.toggleShowEditorStateDialog(true)
      },
    },
    {
      id: `find`,
    ...
    },
    {
      ...
      action: () => {
        uiStore.toggleShowComponentDialog(true)
      },
    },
  ]
